        ...
        <div x-show="$store.confirmModal.show" class="fixed top-0 left-0 z-[99] flex items-center justify-center w-screen h-screen" x-cloak>
            ...
            <div x-show="$store.confirmModal.show"
                ...
                <div class="flex items-center justify-between pb-2">
                    ...
                    <button @click="$store.confirmModal.toggle()" class="absolute top-0 right-0 flex items-center justify-center w-8 h-8 mt-5 mr-5 text-gray-600 rounded-full hover:text-gray-800 hover:bg-gray-50">
